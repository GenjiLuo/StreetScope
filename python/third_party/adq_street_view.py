...
class PanoramaMetadata:
	...
	def DecodePanoMap(self, raw):
		...
		print "numPanos, panoWidth, panoHeight, panoIndicesOffset"
		print numPanos, panoWidth, panoHeight, panoIndicesOffset
	...
	def DecodeDepthMap(self, raw):
		...
		print "numPlanes, panoWidth, panoHeight, planeIndicesOffset"
		print numPlanes, panoWidth, panoHeight, planeIndicesOffset
...
if __name__ == '__main__':
        ...
        print len(pano.PanoMapPanos)
        print len(pano.PanoMapIndices)
        print min(pano.PanoMapIndices), max(pano.PanoMapIndices)
        print pano.DepthMapPlanes
        print len(pano.DepthMapPlanes)
        print len(pano.DepthMapIndices)
        print min(pano.DepthMapIndices), max(pano.DepthMapIndices)
